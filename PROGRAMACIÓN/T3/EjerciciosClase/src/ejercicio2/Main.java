...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            // analizar el numero de aprox, acierts y fallos
            ...
            System.out.println("El número de aciertos "+numeroAciertos);
            System.out.println("El número de errores "+numeroErrores);
            System.out.println("El número de aproximaciones "+numeroAprox);


        } while (intentos >0);

        System.out.println("Saliendo de la palabra");
